...
\hypersetup{
            pdftitle={Synthetic Tabular Data Generation using GAN},
...
\title{Synthetic Tabular Data Generation using GAN}
...
Roshan Pandey %% -- end for/affiliation.institution.author
}
...
\IEEEauthorblockN{
  %% -- beg for/affiliation.institution.author
Nicola Palmarini %% -- end for/affiliation.institution.author
}
